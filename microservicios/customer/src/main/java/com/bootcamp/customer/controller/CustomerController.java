...
public class CustomerController {
    ...
    @PutMapping("/{document}")
    public Mono<ResponseEntity<Customer>> updateAccount(@PathVariable("document") String document, @RequestBody Customer customer){
        return customerService.getCustomerDocument(document)
                .flatMap(cus -> {
    ...
    public Mono<ResponseEntity<Void>> deleteAccount(@PathVariable("document") String document, Customer customer){
        return customerService.getCustomerDocument(document)
